package com.core.commonsdk.view.photoviewer
...
import com.core.commonsdk.view.photoviewer.photoview.PhotoView
...
class PhotoViewerFragment : BaseLazyFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view=inflater.inflate(R.layout.public_item_picture, container, false)
        mIv  = view.findViewById<PhotoView>(R.id.mIv)
